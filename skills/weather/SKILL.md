...
Esta skill busca a previsão do tempo atual e dos próximos dias para uma localização informada pelo usuário, usando a API gratuita e sem necessidade de chave da [Open-Meteo](https://open-meteo.com/).

## Quando usar

Use esta skill sempre que o usuário pedir informações sobre clima/tempo/previsão para uma cidade, endereço, código postal ou coordenadas geográficas (latitude/longitude).
